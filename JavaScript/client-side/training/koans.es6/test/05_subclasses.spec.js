...
describe.skip('Sub classing (test/05_subclasses.spec.js)', () => {
  it('Should extend a class declaration/expression', () => {
    class Animal {
      constructor(name) {
        this.name = name;
      }
  ...
  it('Should extend traditional function-based "classes" ', () => {
