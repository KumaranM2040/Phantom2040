...
function updateCloudFlareDNSARecordIfRequired() {
    var prom = new Promise(function(resolve, reject) {
        ...
        function onSuccess(currentPublicIP) {
            ...
            const options = {
                url: "https://api.cloudflare.com/client/v4/zones/9ec329dd044850e58adaf4b438a55530/dns_records?type=A&name=silverlanternslight.com&status=active&account.id=77a3d8b49911c385263fb6627104a40b&page=1&per_page=20&order=type&direction=desc&match=all",
                json: "true",
                headers: {
            ...
            request(options).then(
                result => {
                    ...
                    if (dnsARecord !== currentPublicIP && currentPublicIP.length > 0) {
                        ...
                        request
                            .patch({
                                url: "https://api.cloudflare.com/client/v4/zones/9ec329dd044850e58adaf4b438a55530/dns_records/" +
                                    dnsId,
                                headers: {
                                    "X-Auth-Email": "kumaranm2040@gmail.com",
                                    "X-Auth-Key": "e6a6ea969e14bcf8832ea36fd2d74730bf267",
